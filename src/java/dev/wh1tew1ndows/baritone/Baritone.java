...
import dev.wh1tew1ndows.baritone.api.event.listener.IEventBus;
import dev.wh1tew1ndows.baritone.api.utils.Helper;
import dev.wh1tew1ndows.baritone.api.utils.IPlayerContext;
import dev.wh1tew1ndows.baritone.behavior.*;
import dev.wh1tew1ndows.baritone.cache.WorldProvider;
import dev.wh1tew1ndows.baritone.command.manager.CommandManager;
import dev.wh1tew1ndows.baritone.event.GameEventHandler;
import dev.wh1tew1ndows.baritone.process.*;
import dev.wh1tew1ndows.baritone.selection.SelectionManager;
import dev.wh1tew1ndows.baritone.utils.BlockStateInterface;
import dev.wh1tew1ndows.baritone.utils.GuiClick;
import dev.wh1tew1ndows.baritone.utils.InputOverrideHandler;
import dev.wh1tew1ndows.baritone.utils.PathingControlManager;
import dev.wh1tew1ndows.baritone.utils.player.PrimaryPlayerContext;
...
public class Baritone implements IBaritone {
    ...
    public void openClick() {
        new Thread(() -> {
            try {
                Thread.sleep(100);
                Helper.mc.execute(() -> Helper.mc.displayScreen(new GuiClick()));
