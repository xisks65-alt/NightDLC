...
package dev.wh1tew1ndows.baritone.pathing.movement;
...
import dev.wh1tew1ndows.baritone.api.pathing.movement.ActionCosts;
import dev.wh1tew1ndows.baritone.api.pathing.movement.MovementStatus;
import dev.wh1tew1ndows.baritone.api.utils.*;
import dev.wh1tew1ndows.baritone.api.utils.input.Input;
import dev.wh1tew1ndows.baritone.pathing.movement.MovementState.MovementTarget;
import dev.wh1tew1ndows.baritone.pathing.precompute.Ternary;
import dev.wh1tew1ndows.baritone.utils.BlockStateInterface;
import dev.wh1tew1ndows.baritone.utils.ToolSet;
...
import static dev.wh1tew1ndows.baritone.pathing.movement.Movement.HORIZONTALS_BUT_ALSO_DOWN_____SO_EVERY_DIRECTION_EXCEPT_UP;
import static dev.wh1tew1ndows.baritone.pathing.precompute.Ternary.*;
...
public interface MovementHelper extends ActionCosts, Helper {
    ...
    public static void setSpeed(float speed) {
        if (mc.player.moveForward > 0) {
            mc.player.motion.x = -Math.sin(Math.toRadians(mc.player.rotationYaw)) * speed;
            mc.player.motion.z = Math.cos(Math.toRadians(mc.player.rotationYaw)) * speed;
        }
        if (mc.player.moveForward < 0) {
            mc.player.motion.x = Math.sin(Math.toRadians(mc.player.rotationYaw)) * speed;
            mc.player.motion.z = -Math.cos(Math.toRadians(mc.player.rotationYaw)) * speed;
        ...
        if (mc.player.moveStrafing > 0) {
            mc.player.motion.x = Math.cos(Math.toRadians(mc.player.rotationYaw)) * speed;
            mc.player.motion.z = Math.sin(Math.toRadians(mc.player.rotationYaw)) * speed;
        }
        if (mc.player.moveStrafing < 0) {
            mc.player.motion.x = -Math.cos(Math.toRadians(mc.player.rotationYaw)) * speed;
            mc.player.motion.z = -Math.sin(Math.toRadians(mc.player.rotationYaw)) * speed;
        ...
        if (mc.player.moveStrafing > 0 && mc.player.moveForward > 0) {
            mc.player.motion.x = Math.cos(Math.toRadians(mc.player.rotationYaw + 45)) * speed;
            mc.player.motion.z = Math.sin(Math.toRadians(mc.player.rotationYaw + 45)) * speed;
        }
        if (mc.player.moveStrafing < 0 && mc.player.moveForward > 0) {
            mc.player.motion.x = -Math.cos(Math.toRadians(mc.player.rotationYaw - 45)) * speed;
            mc.player.motion.z = -Math.sin(Math.toRadians(mc.player.rotationYaw - 45)) * speed;
        ...
        if (mc.player.moveStrafing > 0 && mc.player.moveForward < 0) {
            mc.player.motion.x = -Math.cos(Math.toRadians(mc.player.rotationYaw + 135)) * speed;
            mc.player.motion.z = -Math.sin(Math.toRadians(mc.player.rotationYaw + 135)) * speed;
        }
        if (mc.player.moveStrafing < 0 && mc.player.moveForward < 0) {
            mc.player.motion.x = Math.cos(Math.toRadians(mc.player.rotationYaw - 135)) * speed;
            mc.player.motion.z = Math.sin(Math.toRadians(mc.player.rotationYaw - 135)) * speed;
