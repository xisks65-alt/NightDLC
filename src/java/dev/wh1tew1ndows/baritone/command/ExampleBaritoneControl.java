...
package dev.wh1tew1ndows.baritone.command;

import dev.wh1tew1ndows.baritone.api.BaritoneAPI;
import dev.wh1tew1ndows.baritone.api.IBaritone;
import dev.wh1tew1ndows.baritone.api.Settings;
import dev.wh1tew1ndows.baritone.api.command.argument.ICommandArgument;
import dev.wh1tew1ndows.baritone.api.command.exception.CommandNotEnoughArgumentsException;
import dev.wh1tew1ndows.baritone.api.command.exception.CommandNotFoundException;
import dev.wh1tew1ndows.baritone.api.command.helpers.TabCompleteHelper;
import dev.wh1tew1ndows.baritone.api.command.manager.ICommandManager;
import dev.wh1tew1ndows.baritone.api.event.events.ChatEvent;
import dev.wh1tew1ndows.baritone.api.event.events.TabCompleteEvent;
import dev.wh1tew1ndows.baritone.api.event.listener.AbstractGameEventListener;
import dev.wh1tew1ndows.baritone.api.utils.Helper;
import dev.wh1tew1ndows.baritone.api.utils.SettingsUtil;
import dev.wh1tew1ndows.baritone.command.argument.ArgConsumer;
import dev.wh1tew1ndows.baritone.command.argument.CommandArguments;
import dev.wh1tew1ndows.baritone.command.manager.CommandManager;
import dev.wh1tew1ndows.baritone.utils.accessor.IGuiScreen;
...
import static dev.wh1tew1ndows.baritone.api.command.IBaritoneChatControl.FORCE_COMMAND_PREFIX;
