...
package dev.wh1tew1ndows.baritone.api.utils.gui;
...
public class BaritoneToast implements IToast {
    ...
    public static void addOrUpdate(ITextComponent title, ITextComponent subtitle) {
        addOrUpdate(net.minecraft.client.Minecraft.getInstance().getToastGui(), title, subtitle, dev.wh1tew1ndows.baritone.api.BaritoneAPI.getSettings().toastTimer.value);
    }
}
