...
public class Rotation implements IMinecraft {
     ...
     */
    public float getYaw() {
    	IBaritone baritone = BaritoneAPI.getProvider().getBaritoneForPlayer((ClientPlayerEntity) mc.player);
    	
    	//if (baritone.getMineProcess().isActive() || baritone.getFollowProcess().isActive())
    	//	mc.player.rotationYaw = this.yaw;
    	YAW = dev.wh1tew1ndows.client.utils.rotation.aura.Rotation.correctRotation(yaw , pitch).x;;
    ...
    public float getPitch() {
    	...
    	PITCH = dev.wh1tew1ndows.client.utils.rotation.aura.Rotation.correctRotation(yaw, pitch ).y;
        return PITCH;
    }
