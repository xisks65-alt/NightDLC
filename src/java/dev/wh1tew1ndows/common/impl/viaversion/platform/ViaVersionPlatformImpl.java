...
import dev.wh1tew1ndows.common.impl.viaversion.platform.viaversion.ViaAPIWrapper;
import dev.wh1tew1ndows.common.impl.viaversion.platform.viaversion.ViaConfig;
import dev.wh1tew1ndows.common.impl.viaversion.util.ViaTask;
...
public class ViaVersionPlatformImpl
    ...
    public ViaVersionPlatformImpl(Logger logger) {
        this.logger = logger;
        this.config = new ViaConfig(new File(Minecraft.getInstance().gameDir + "/via_night/", "viaversion.yml"));
    }
