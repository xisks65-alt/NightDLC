...
public class BlurShader implements IMinecraft {
    private final ShaderManager upSample = ShaderManager.create(new KawaseBlurUp());
    private final ShaderManager downSample = ShaderManager.create(new KawaseBlurDown());
    ...
    private void initFramebuffers(float iterations) {
        ...
        framebufferList.add(outFramebuffer = ShaderManager.createFrameBuffer(null, true));
        ...
        for (int i = 0; i <= iterations; i++) {
            ...
            Framebuffer currentBuffer = new Framebuffer(width, height, true, false);
