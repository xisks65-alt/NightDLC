...
import dev.wh1tew1ndows.baritone.utils.accessor.IPlayerControllerMP;
...
import dev.wh1tew1ndows.client.managers.module.impl.player.NoInteract;
    ...
    public ActionResultType rightClickBlock(ClientPlayerEntity p_217292_1_, ClientWorld p_217292_2_, Hand p_217292_3_, BlockRayTraceResult p_217292_4_) {
        ...
        if (!this.mc.world.getWorldBorder().contains(blockpos)) {
            ...
            if (this.currentGameType == GameType.SPECTATOR) {
                ...
                boolean flag2 = Zetrix.inst().moduleManager().get(NoInteract.class).isEnabled() &&
