...
public class ServerList {
    ...
    public void loadServerList() {
        try {
            ...
            ServerData pinnedServer = new ServerData("CakeWorld", "mc.cakeworld.pw", false);
            pinnedServer.setPinned(true);
            this.servers.add(pinnedServer);
            ...
            for (int i = 0; i < listnbt.size(); ++i) {
                ...
                if (!serverData.serverIP.equalsIgnoreCase("mc.cakeworld.pw")) {
    ...
    public void saveServerList() {
        try {
            ...
            for (ServerData serverdata : this.servers) {
                if (serverdata.isAutodob() || serverdata.isPinned()) continue;
