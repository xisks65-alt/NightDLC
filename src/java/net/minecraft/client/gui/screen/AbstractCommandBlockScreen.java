...
public abstract class AbstractCommandBlockScreen extends Screen {
    ...
    protected void init() {
        ...
        this.commandTextField.setTextFieldFocused(true);
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredStringWithShadow(matrixStack, this.font, field_243330_s, this.width / 2, 20, 16777215);
        drawStringWithShadow(matrixStack, this.font, field_243331_t, this.width / 2 - 150, 40, 10526880);
        ...
        if (!this.resultTextField.getText().isEmpty()) {
            ...
            drawStringWithShadow(matrixStack, this.font, field_243332_u, this.width / 2 - 150, i + 4, 10526880);
