...
public class LanguageScreen extends SettingsScreen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredStringWithShadow(matrixStack, this.font, this.title, this.width / 2, 16, 16777215);
        drawCenteredStringWithShadow(matrixStack, this.font, field_243292_c, this.width / 2, this.height - 56, 8421504);
    ...
    class List extends ExtendedList<LanguageScreen.List.LanguageEntry> {
        ...
        public class LanguageEntry extends ExtendedList.AbstractListEntry<LanguageScreen.List.LanguageEntry> {
            ...
            public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
                ...
                LanguageScreen.this.font.drawStringWithShadow(p_230432_1_, s, (float) (List.this.width / 2 - LanguageScreen.this.font.getStringWidth(s) / 2), (float) (p_230432_3_ + 1), 16777215, true);
            }
