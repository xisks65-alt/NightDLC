...
public class WorldOptionsScreen implements IScreen, IRenderable {
    ...
    public void func_239048_a_(final CreateWorldScreen p_239048_1_, Minecraft p_239048_2_, FontRenderer p_239048_3_) {
        ...
        this.field_239037_k_ = p_239048_1_.addButton(new Button(i, 185, 150, 20, new TranslationTextComponent("selectWorld.import_worldgen_settings"), (p_239049_3_) ->
        {
            ...
            String s = TinyFileDialogs.tinyfd_openFileDialog(translationtextcomponent.getString(), null, null, null, false);
            ...
            if (s != null) {
                ...
                try {
                    ...
                    CompletableFuture<DataPackRegistries> completablefuture = DataPackRegistries.func_240961_a_(resourcepacklist.getResourcePacks(), Commands.EnvironmentType.INTEGRATED, 2, Util.getServerExecutor(), p_239048_2_);
                    p_239048_2_.driveUntil(completablefuture::isDone);
                    datapackregistries = completablefuture.get();
                } catch (ExecutionException | InterruptedException interruptedexception) {
                    field_239028_b_.error("Error loading data packs when importing world settings", interruptedexception);
                ...
                if (dataresult.error().isPresent()) {
                    ...
                    field_239028_b_.error("Error parsing world settings: {}", s1);
                }
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        if (this.field_239034_h_.visible) {
            this.field_239031_e_.drawStringWithShadow(matrixStack, field_243442_e, (float) (this.field_239032_f_ / 2 - 150), 122.0F, -6250336);
        }
