...
public class GamemodeSelectionScreen extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        if (!this.func_238718_l_()) {
            ...
            {
                drawCenteredStringWithShadow(matrixStack, this.font, p_238712_2_.func_238725_a_(), this.width / 2, this.height / 2 - 30 - 20, -1);
            });
            drawCenteredStringWithShadow(matrixStack, this.font, field_238705_c_, this.width / 2, this.height / 2 + 5, 16777215);
    ...
    enum Mode {
        ...
        private static final GamemodeSelectionScreen.Mode[] field_238721_e_ = values();
        final ITextComponent field_238722_f_;
        final String field_238723_g_;
        final ItemStack field_238724_h_;

        Mode(ITextComponent p_i232285_3_, String p_i232285_4_, ItemStack p_i232285_5_) {
    ...
    public class SelectorWidget extends Widget {
        ...
        private void func_238738_a_(MatrixStack p_238738_1_, TextureManager p_238738_2_) {
            ...
            p_238738_1_.push();
            p_238738_1_.translate(this.x, this.y, 0.0D);
        ...
        private void func_238740_b_(MatrixStack p_238740_1_, TextureManager p_238740_2_) {
            ...
            p_238740_1_.push();
            p_238740_1_.translate(this.x, this.y, 0.0D);
