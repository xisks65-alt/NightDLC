...
public class EditStructureScreen extends Screen {
    ...
    protected void init() {
        ...
        this.nameEdit = new TextFieldWidget(this.font, this.width / 2 - 152, 40, 300, 20, new TranslationTextComponent("structure_block.structure_name")) {
            public boolean charTyped(char codePoint, int modifiers) {
                return EditStructureScreen.this.isValidCharacterForName(this.getText(), codePoint, this.getCursorPosition()) && super.charTyped(codePoint, modifiers);
            }
        };
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (structuremode != StructureMode.DATA) {
            drawStringWithShadow(matrixStack, this.font, field_243355_a, this.width / 2 - 153, 30, 10526880);
        ...
        if (structuremode == StructureMode.LOAD || structuremode == StructureMode.SAVE) {
            drawStringWithShadow(matrixStack, this.font, field_243356_b, this.width / 2 - 153, 70, 10526880);
            ...
            drawStringWithShadow(matrixStack, this.font, field_243360_r, this.width / 2 + 154 - this.font.getStringPropertyWidth(field_243360_r), 150, 10526880);
        }

        if (structuremode == StructureMode.SAVE) {
            drawStringWithShadow(matrixStack, this.font, field_243357_c, this.width / 2 - 153, 110, 10526880);
            ...
            drawStringWithShadow(matrixStack, this.font, field_243361_s, this.width / 2 + 154 - this.font.getStringPropertyWidth(field_243361_s), 110, 10526880);
            drawStringWithShadow(matrixStack, this.font, field_243362_t, this.width / 2 + 154 - this.font.getStringPropertyWidth(field_243362_t), 70, 10526880);
        }

        if (structuremode == StructureMode.LOAD) {
            drawStringWithShadow(matrixStack, this.font, field_243358_p, this.width / 2 - 153, 110, 10526880);
            ...
            drawStringWithShadow(matrixStack, this.font, field_243363_u, this.width / 2 + 154 - this.font.getStringPropertyWidth(field_243363_u), 70, 10526880);
        }

        if (structuremode == StructureMode.DATA) {
            drawStringWithShadow(matrixStack, this.font, field_243359_q, this.width / 2 - 153, 110, 10526880);
            this.dataEdit.render(matrixStack, mouseX, mouseY, partialTicks);
        }

        drawStringWithShadow(matrixStack, this.font, structuremode.func_242703_b(), this.width / 2 - 153, 174, 10526880);
