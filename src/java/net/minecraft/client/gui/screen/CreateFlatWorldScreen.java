...
public class CreateFlatWorldScreen extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawStringWithShadow(matrixStack, this.font, this.materialText, i, 32, 16777215);
        drawStringWithShadow(matrixStack, this.font, this.heightText, i + 2 + 213 - this.font.getStringPropertyWidth(this.heightText), 32, 16777215);
    ...
    class DetailsList extends ExtendedList<CreateFlatWorldScreen.DetailsList.LayerEntry> {
        ...
        class LayerEntry extends ExtendedList.AbstractListEntry<CreateFlatWorldScreen.DetailsList.LayerEntry> {
            ...
            public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
                ...
                CreateFlatWorldScreen.this.font.drawString(p_230432_1_, item.getDisplayName(itemstack), (float) (p_230432_4_ + 18 + 5), (float) (p_230432_3_ + 3), 16777215);
                String s;
