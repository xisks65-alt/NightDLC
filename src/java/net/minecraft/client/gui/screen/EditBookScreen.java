...
public class EditBookScreen extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.bookGettingSigned) {
            ...
            this.font.drawString(matrixStack, field_243340_a, (float) (i + 36 + (114 - k) / 2), 34.0F, 0);
            int l = this.font.func_243245_a(ireorderingprocessor);
            this.font.drawString(matrixStack, ireorderingprocessor, (float) (i + 36 + (114 - l) / 2), 50.0F, 0);
            int i1 = this.font.getStringPropertyWidth(this.field_243339_L);
            this.font.drawString(matrixStack, this.field_243339_L, (float) (i + 36 + (114 - i1) / 2), 60.0F, 0);
            this.font.func_238418_a_(field_243341_b, i + 36, 82, 114, 0);
        } else {
            int j1 = this.font.getStringPropertyWidth(this.field_243338_K);
            this.font.drawString(matrixStack, this.field_243338_K, (float) (i - j1 + 192 - 44), 18.0F, 0);
            EditBookScreen.BookPage editbookscreen$bookpage = this.func_238750_B_();

            for (EditBookScreen.BookLine editbookscreen$bookline : editbookscreen$bookpage.field_238784_f_) {
                this.font.drawString(matrixStack, editbookscreen$bookline.field_238797_c_, (float) editbookscreen$bookline.field_238798_d_, (float) editbookscreen$bookline.field_238799_e_, -16777216);
            }
