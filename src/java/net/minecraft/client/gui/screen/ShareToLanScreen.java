...
public class ShareToLanScreen extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredStringWithShadow(matrixStack, this.font, this.title, this.width / 2, 50, 16777215);
        drawCenteredStringWithShadow(matrixStack, this.font, field_243312_c, this.width / 2, 82, 16777215);
