...
public class StatsScreen extends Screen implements IProgressMeter {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            drawCenteredStringWithShadow(matrixStack, this.font, field_243320_c, this.width / 2, this.height / 2, 16777215);
            drawCenteredStringWithShadow(matrixStack, this.font, LOADING_STRINGS[(int) (Util.milliTime() / 150L % (long) LOADING_STRINGS.length)], this.width / 2, this.height / 2 + 9 * 2, 16777215);
        } else {
    ...
    class CustomStatsList extends ExtendedList<StatsScreen.CustomStatsList.Entry> {
        ...
        class Entry extends ExtendedList.AbstractListEntry<StatsScreen.CustomStatsList.Entry> {
            ...
            public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
                AbstractGui.drawStringWithShadow(p_230432_1_, StatsScreen.this.font, this.field_243321_c, p_230432_4_ + 2, p_230432_3_ + 1, p_230432_2_ % 2 == 0 ? 16777215 : 9474192);
                String s = this.field_214405_b.format(StatsScreen.this.stats.getValue(this.field_214405_b));
                AbstractGui.drawStringWithShadow(p_230432_1_, StatsScreen.this.font, s, p_230432_4_ + 2 + 213 - StatsScreen.this.font.getStringWidth(s), p_230432_3_ + 1, p_230432_2_ % 2 == 0 ? 16777215 : 9474192);
            }
        }
    }
    ...
    class MobStatsList extends ExtendedList<StatsScreen.MobStatsList.Entry> {
        ...
        class Entry extends ExtendedList.AbstractListEntry<StatsScreen.MobStatsList.Entry> {
            ...
            public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
                AbstractGui.drawStringWithShadow(p_230432_1_, StatsScreen.this.font, this.field_243322_c, p_230432_4_ + 2, p_230432_3_ + 1, 16777215);
                AbstractGui.drawStringWithShadow(p_230432_1_, StatsScreen.this.font, this.field_243323_d, p_230432_4_ + 2 + 10, p_230432_3_ + 1 + 9, this.field_243324_e ? 9474192 : 6316128);
                AbstractGui.drawStringWithShadow(p_230432_1_, StatsScreen.this.font, this.field_243325_f, p_230432_4_ + 2 + 10, p_230432_3_ + 1 + 9 * 2, this.field_243326_g ? 9474192 : 6316128);
            }
        }
    }
    ...
    class StatsList extends ExtendedList<StatsScreen.StatsList.Entry> {
        ...
        protected void renderDecorations(MatrixStack p_230447_1_, int p_230447_2_, int p_230447_3_) {
            if (p_230447_3_ >= this.y0 && p_230447_3_ <= this.y1) {
                StatsScreen.StatsList.Entry statsscreen$statslist$entry = this.getEntryAtPosition(p_230447_2_, p_230447_3_);
        ...
        protected void func_238680_a_(MatrixStack p_238680_1_, @Nullable ITextComponent p_238680_2_, int p_238680_3_, int p_238680_4_) {
            if (p_238680_2_ != null) {
                ...
                StatsScreen.this.font.drawStringWithShadow(p_238680_1_, p_238680_2_, (float) i, (float) j, -1);
        ...
        class Entry extends ExtendedList.AbstractListEntry<StatsScreen.StatsList.Entry> {
            ...
            protected void func_238681_a_(MatrixStack p_238681_1_, @Nullable Stat<?> p_238681_2_, int p_238681_3_, int p_238681_4_, boolean p_238681_5_) {
                ...
                AbstractGui.drawStringWithShadow(p_238681_1_, StatsScreen.this.font, s, p_238681_3_ - StatsScreen.this.font.getStringWidth(s), p_238681_4_ + 5, p_238681_5_ ? 16777215 : 9474192);
            }
        }
    }
}
