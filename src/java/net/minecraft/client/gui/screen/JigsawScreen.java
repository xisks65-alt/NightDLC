...
public class JigsawScreen extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawStringWithShadow(matrixStack, this.font, field_243347_b, this.width / 2 - 153, 10, 10526880);
        this.field_238820_p_.render(matrixStack, mouseX, mouseY, partialTicks);
        drawStringWithShadow(matrixStack, this.font, field_243348_c, this.width / 2 - 153, 45, 10526880);
        this.field_238818_b_.render(matrixStack, mouseX, mouseY, partialTicks);
        drawStringWithShadow(matrixStack, this.font, field_243349_p, this.width / 2 - 153, 80, 10526880);
        this.field_238819_c_.render(matrixStack, mouseX, mouseY, partialTicks);
        drawStringWithShadow(matrixStack, this.font, field_243350_q, this.width / 2 - 153, 115, 10526880);
        ...
        if (JigsawBlock.getConnectingDirection(this.field_214259_a.getBlockState()).getAxis().isVertical()) {
            drawStringWithShadow(matrixStack, this.font, field_243346_a, this.width / 2 - 153, 156, 16777215);
        }
