...
public class ReadBookScreen extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        this.font.drawString(matrixStack, this.field_243344_s, (float) (i - i1 + 192 - 44), 18.0F, 0);
        int k = Math.min(128 / 9, this.cachedPageLines.size());

        for (int l = 0; l < k; ++l) {
            IReorderingProcessor ireorderingprocessor = this.cachedPageLines.get(l);
            this.font.drawString(matrixStack, ireorderingprocessor, (float) (i + 36), (float) (32 + l * 9), 0);
        }
    ...
    public interface IBookInfo {
        ...
        static ReadBookScreen.IBookInfo func_216917_a(ItemStack p_216917_0_) {
            ...
            if (item == Items.WRITTEN_BOOK) {
                ...
                return item == Items.WRITABLE_BOOK ? new UnwrittenBookInfo(p_216917_0_) : ReadBookScreen.EMPTY_BOOK;
            }
        }
    }
