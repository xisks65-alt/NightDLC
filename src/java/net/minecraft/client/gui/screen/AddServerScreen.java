...
public class AddServerScreen extends Screen {
    ...
    protected void init() {
        ...
        this.textFieldServerName.setTextFieldFocused(true);
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredStringWithShadow(matrixStack, this.font, this.title, this.width / 2, 17, 16777215);
        drawStringWithShadow(matrixStack, this.font, field_243290_a, this.width / 2 - 100, 53, 10526880);
        drawStringWithShadow(matrixStack, this.font, field_243291_b, this.width / 2 - 100, 94, 10526880);
