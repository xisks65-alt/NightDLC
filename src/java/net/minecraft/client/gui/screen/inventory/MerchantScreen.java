...
public class MerchantScreen extends ContainerScreen<MerchantContainer> {
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int x, int y) {
        ...
        if (i > 0 && i <= 5 && this.container.func_217042_i()) {
            ...
            this.font.drawString(matrixStack, itextcomponent, (float) k, 6.0F, 4210752);
        } else {
            this.font.drawString(matrixStack, this.title, (float) (49 + this.xSize / 2 - this.font.getStringPropertyWidth(this.title) / 2), 6.0F, 4210752);
        }
        ...
        this.font.drawString(matrixStack, field_243351_B, (float) (5 - l / 2 + 48), 6.0F, 4210752);
    }
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (!merchantoffers.isEmpty()) {
            ...
            if (merchantoffer1.hasNoUsesLeft() && this.isPointInRegion(186, 35, 22, 21, mouseX, mouseY) && this.container.func_223432_h()) {
