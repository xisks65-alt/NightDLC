...
import dev.wh1tew1ndows.client.managers.module.impl.misc.ItemScroller;
...
public abstract class ContainerScreen<T extends Container> extends Screen implements IHasContainer<T> {
    ...
    public boolean getHasDraggingStack;
    ...
    protected void renderHoveredTooltip(MatrixStack matrixStack, int x, int y) {
        if (this.minecraft.player.inventory.getItemStack().isEmpty() && this.hoveredSlot != null && this.hoveredSlot.getHasStack()) {
            ShulkerPreviewRenderEvent shulkerPreviewRenderEvent = new ShulkerPreviewRenderEvent(matrixStack, x, y, hoveredSlot, this);
            shulkerPreviewRenderEvent.hook();
