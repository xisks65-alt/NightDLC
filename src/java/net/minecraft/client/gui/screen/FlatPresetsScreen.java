...
public class FlatPresetsScreen extends Screen {
    ...
    private static FlatLayerInfo func_238638_a_(String p_238638_0_, int p_238638_1_) {
        ...
        if (astring.length == 2) {
            try {
                ...
                field_238631_a_.error("Error while parsing flat world string => {}", numberformatexception.getMessage());
                return null;
            }
        } else {
            i = 1;
        ...
        try {
            ...
            field_238631_a_.error("Error while parsing flat world string => {}", exception.getMessage());
            return null;
        }

        if (block == null) {
            field_238631_a_.error("Error while parsing flat world string => Unknown block, {}", s);
            return null;
        } else {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawStringWithShadow(matrixStack, this.font, this.presetsShare, 50, 30, 10526880);
        drawStringWithShadow(matrixStack, this.font, this.listText, 50, 70, 10526880);
    ...
    static {
        func_238640_a_(new TranslationTextComponent("createWorld.customize.preset.classic_flat"), Blocks.GRASS_BLOCK, Biomes.PLAINS, List.of(Structure.field_236381_q_), false, false, false, new FlatLayerInfo(1, Blocks.GRASS_BLOCK), new FlatLayerInfo(2, Blocks.DIRT), new FlatLayerInfo(1, Blocks.BEDROCK));
        func_238640_a_(new TranslationTextComponent("createWorld.customize.preset.tunnelers_dream"), Blocks.STONE, Biomes.MOUNTAINS, List.of(Structure.field_236367_c_), true, true, false, new FlatLayerInfo(1, Blocks.GRASS_BLOCK), new FlatLayerInfo(5, Blocks.DIRT), new FlatLayerInfo(230, Blocks.STONE), new FlatLayerInfo(1, Blocks.BEDROCK));
        ...
        func_238640_a_(new TranslationTextComponent("createWorld.customize.preset.bottomless_pit"), Items.FEATHER, Biomes.PLAINS, List.of(Structure.field_236381_q_), false, false, false, new FlatLayerInfo(1, Blocks.GRASS_BLOCK), new FlatLayerInfo(3, Blocks.DIRT), new FlatLayerInfo(2, Blocks.COBBLESTONE));
    ...
    class SlotList extends ExtendedList<FlatPresetsScreen.SlotList.PresetEntry> {
        ...
        public class PresetEntry extends ExtendedList.AbstractListEntry<FlatPresetsScreen.SlotList.PresetEntry> {
            public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
                ...
                FlatPresetsScreen.this.font.drawString(p_230432_1_, flatpresetsscreen$layeritem.name, (float) (p_230432_4_ + 18 + 5), (float) (p_230432_3_ + 6), 16777215);
            }
