...
public class OptimizeWorldScreen extends Screen {
    ...
    public static OptimizeWorldScreen func_239025_a_(Minecraft p_239025_0_, BooleanConsumer p_239025_1_, DataFixer p_239025_2_, SaveFormat.LevelSave p_239025_3_, boolean p_239025_4_) {
        ...
        try (Minecraft.PackManager minecraft$packmanager = p_239025_0_.reloadDatapacks(dynamicregistries$impl, Minecraft::loadDataPackCodec, Minecraft::loadWorld, false, p_239025_3_)) {
            ...
            field_239024_a_.warn("Failed to load datapacks, can't optimize world", exception);
            return null;
        }
    }
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        int l = k + 10;
        drawCenteredStringWithShadow(matrixStack, this.font, this.optimizer.getStatusText(), this.width / 2, k - 9 - 2, 10526880);

        if (this.optimizer.getTotalChunks() > 0) {
            fill(matrixStack, i - 1, k - 1, j + 1, l + 1, -16777216);
            drawStringWithShadow(matrixStack, this.font, new TranslationTextComponent("optimizeWorld.info.converted", this.optimizer.getConverted()), i, 40, 10526880);
            drawStringWithShadow(matrixStack, this.font, new TranslationTextComponent("optimizeWorld.info.skipped", this.optimizer.getSkipped()), i, 40 + 9 + 3, 10526880);
            drawStringWithShadow(matrixStack, this.font, new TranslationTextComponent("optimizeWorld.info.total", this.optimizer.getTotalChunks()), i, 40 + (9 + 3) * 2, 10526880);
            int i1 = 0;
            ...
            drawCenteredStringWithShadow(matrixStack, this.font, k1 + " / " + this.optimizer.getTotalChunks(), this.width / 2, k + 2 * 9 + 2, 10526880);
            drawCenteredStringWithShadow(matrixStack, this.font, MathHelper.floor(this.optimizer.getTotalProgress() * 100.0F) + "%", this.width / 2, k + (l - k) / 2 - 9 / 2, 10526880);
        }
