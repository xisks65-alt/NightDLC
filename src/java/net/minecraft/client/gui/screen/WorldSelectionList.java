...
public class WorldSelectionList extends ExtendedList<WorldSelectionList.Entry> {
    ...
    public void func_212330_a(Supplier<String> p_212330_1_, boolean p_212330_2_) {
        ...
        if (this.field_212331_y.isEmpty()) {
            this.minecraft.displayScreen(CreateWorldScreen.func_243425_a(null));
        } else {
    ...
    public final class Entry extends ExtendedList.AbstractListEntry<WorldSelectionList.Entry> implements AutoCloseable {
        ...
        public void render(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            ...
            this.field_214449_b.fontRenderer.drawString(p_230432_1_, itextcomponent, (float) (p_230432_4_ + 32 + 3), (float) (p_230432_3_ + 9 + 9 + 3), 8421504);
                    ...
                    this.field_214449_b.displayScreen(new ConfirmScreen((p_214434_1_) ->
                    {
                        if (p_214434_1_) {
                            try {
                                ...
                                WorldSelectionList.LOGGER.error("Failure to open 'future world'", exception);
        ...
        public void func_214445_d() {
            ...
            try (
                ...
                if (dimensiongeneratorsettings.func_236229_j_()) {
                    ...
                    {
                        this.field_214449_b.displayScreen(p_239095_6_ ? new CreateWorldScreen(this.field_214450_c, worldsettings, dimensiongeneratorsettings, path, datapackcodec, dynamicregistries$impl) : this.field_214450_c);
