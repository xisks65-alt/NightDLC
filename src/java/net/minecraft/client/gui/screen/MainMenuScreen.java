...
public class MainMenuScreen extends Screen {
    ...
    protected void init() {
        //  textBox = new TextBox(new Vector2f(5, 5), Fonts.SF_BOLD, 8, -1, TextAlign.LEFT, "Введите никнейм", 0, false, false);
    ...
    private void addSingleplayerMultiplayerButtons(int yIn, int rowHeightIn) {
        ...
        this.addButton(new Button(this.width / 2 - (140 / 2), yIn + 76, 140, 20, new StringTextComponent("Alt Manager"), (p_lambda$addSingleplayerMultiplayerButtons$4_1_) ->
        {
            this.minecraft.displayScreen(Zetrix.inst().altWidget());
        }));
