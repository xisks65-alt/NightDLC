...
public class VideoSettingsScreen extends GuiScreenOF {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredStringWithShadow(matrixStack, this.minecraft.fontRenderer, this.title, this.width / 2, 15, 16777215);
        ...
        drawStringWithShadow(matrixStack, this.minecraft.fontRenderer, s, 2, this.height - 10, 8421504);
        String s2 = "Minecraft 1.16.5";
        int i = this.minecraft.fontRenderer.getStringWidth(s2);
        drawStringWithShadow(matrixStack, this.minecraft.fontRenderer, s2, this.width - i - 2, this.height - 10, 8421504);
