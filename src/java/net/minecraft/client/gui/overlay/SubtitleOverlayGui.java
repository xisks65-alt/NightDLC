    ...
    public void render(MatrixStack p_195620_1_) {
        ...
        if (this.enabled && !this.subtitles.isEmpty()) {
            ...
            for (SubtitleOverlayGui.Subtitle subtitleoverlaygui$subtitle1 : this.subtitles) {
                ...
                int l1 = MathHelper.floor(MathHelper.clampedLerp(255.0D, 75.0D, (float) (Util.milliTime() - subtitleoverlaygui$subtitle1.getStartTime()) / 3000.0F));
                int i2 = l1 << 16 | l1 << 8 | l1;
                RenderSystem.pushMatrix();
                RenderSystem.translatef((float) this.client.getMainWindow().getScaledWidth() - (float) l - 2.0F, (float) (this.client.getMainWindow().getScaledHeight() - 30) - (float) (i * (i1 + 1)), 0.0F);
                ...
                this.client.fontRenderer.drawString(p_195620_1_, itextcomponent, (float) (-k1 / 2), (float) (-j1), i2 + -16777216);
