            ...
            for (int i = 0; i < 128; ++i) {
                for (int j = 0; j < 128; ++j) {
                    ...
                    if (l / 4 == 0) {
                        ...
                        this.mapTexture.getTextureData().setPixelRGBA(j, i, MaterialColor.MATERIAL_COLORS[MathHelper.clamp(l / 4, 0, MaterialColor.MATERIAL_COLORS.length - 1)].getMapColor(l & 3));
                    }
                }
            }
