...
public class TextFieldWidget extends Widget implements IRenderable, IGuiEventListener {
     ...
     */
    public void setTextFieldFocused(boolean isFocusedIn) {
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        if (this.getVisible()) {
            ...
            if (!s.isEmpty()) {
                ...
                j1 = this.fontRenderer.drawStringWithShadow(matrixStack, this.textFormatter.apply(s1, this.lineScrollOffset), (float) l, (float) i1, i2);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                this.fontRenderer.drawStringWithShadow(matrixStack, this.textFormatter.apply(s.substring(j), this.cursorPosition), (float) j1, (float) i1, i2);
            }
