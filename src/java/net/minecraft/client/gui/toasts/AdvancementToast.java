...
public class AdvancementToast implements IToast
{
    ...
    public Visibility func_230444_a_(MatrixStack p_230444_1_, ToastGui p_230444_2_, long p_230444_3_)
    {
        ...
        if (displayinfo != null)
        {
            ...
            if (list.size() == 1)
            {
                p_230444_2_.getMinecraft().fontRenderer.drawString(p_230444_1_, displayinfo.getFrame().getTranslatedToast(), 30.0F, 7.0F, i | -16777216);
                p_230444_2_.getMinecraft().fontRenderer.drawString(p_230444_1_, list.get(0), 30.0F, 18.0F, -1);
            }
            else
            {
                int j = 1500;
                ...
                if (p_230444_3_ < 1500L)
                {
                    ...
                    p_230444_2_.getMinecraft().fontRenderer.drawString(p_230444_1_, displayinfo.getFrame().getTranslatedToast(), 30.0F, 11.0F, i | k);
                }
                else
                {
                    ...
                    {
                        p_230444_2_.getMinecraft().fontRenderer.drawString(p_230444_1_, ireorderingprocessor, 30.0F, (float)l, 16777215 | i1);
                        l += 9;
                    }
                }
            }
