...
public class SystemToast implements IToast
{
    ...
    public Visibility func_230444_a_(MatrixStack p_230444_1_, ToastGui p_230444_2_, long p_230444_3_)
    {
        ...
        {
            p_230444_2_.getMinecraft().fontRenderer.drawString(p_230444_1_, this.title, 18.0F, 12.0F, -256);
        }
        else
        {
            p_230444_2_.getMinecraft().fontRenderer.drawString(p_230444_1_, this.title, 18.0F, 7.0F, -256);

            for (int k1 = 0; k1 < this.field_238531_e_.size(); ++k1)
            {
                p_230444_2_.getMinecraft().fontRenderer.drawString(p_230444_1_, this.field_238531_e_.get(k1), 18.0F, (float)(18 + k1 * 12), -1);
            }
        }
