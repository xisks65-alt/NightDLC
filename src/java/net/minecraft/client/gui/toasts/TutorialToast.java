...
public class TutorialToast implements IToast
{
    ...
    public Visibility func_230444_a_(MatrixStack p_230444_1_, ToastGui p_230444_2_, long p_230444_3_)
    {
        ...
        {
            p_230444_2_.getMinecraft().fontRenderer.drawString(p_230444_1_, this.title, 30.0F, 12.0F, -11534256);
        }
        else
        {
            p_230444_2_.getMinecraft().fontRenderer.drawString(p_230444_1_, this.title, 30.0F, 7.0F, -11534256);
            p_230444_2_.getMinecraft().fontRenderer.drawString(p_230444_1_, this.subtitle, 30.0F, 18.0F, -16777216);
        }
