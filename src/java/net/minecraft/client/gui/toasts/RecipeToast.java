...
public class RecipeToast implements IToast
{
    ...
    public Visibility func_230444_a_(MatrixStack p_230444_1_, ToastGui p_230444_2_, long p_230444_3_)
    {
        ...
        else
        {
            ...
            p_230444_2_.getMinecraft().fontRenderer.drawString(p_230444_1_, field_243272_c, 30.0F, 7.0F, -11534256);
            p_230444_2_.getMinecraft().fontRenderer.drawString(p_230444_1_, field_243273_d, 30.0F, 18.0F, -16777216);
