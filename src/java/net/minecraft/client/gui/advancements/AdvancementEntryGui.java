...
public class AdvancementEntryGui extends AbstractGui {
    ...
    public void drawAdvancementHover(MatrixStack matrixStack, int x, int y, float fade, int width, int height) {
        ...
        if (flag) {
            this.minecraft.fontRenderer.drawStringWithShadow(matrixStack, this.title, (float) (i1 + 5), (float) (y + this.y + 9), -1);

            if (s != null) {
                this.minecraft.fontRenderer.drawStringWithShadow(matrixStack, s, (float) (x + this.x - i), (float) (y + this.y + 9), -1);
            }
        } else {
            this.minecraft.fontRenderer.drawStringWithShadow(matrixStack, this.title, (float) (x + this.x + 32), (float) (y + this.y + 9), -1);
        ...
        if (flag1) {
            for (int k1 = 0; k1 < this.description.size(); ++k1) {
                this.minecraft.fontRenderer.drawString(matrixStack, this.description.get(k1), (float) (i1 + 5), (float) (l + 26 - j1 + 7 + k1 * 9), -5592406);
            }
        } else {
            for (int l1 = 0; l1 < this.description.size(); ++l1) {
                this.minecraft.fontRenderer.drawString(matrixStack, this.description.get(l1), (float) (i1 + 5), (float) (y + this.y + 9 + 17 + l1 * 9), -5592406);
            }
        }
