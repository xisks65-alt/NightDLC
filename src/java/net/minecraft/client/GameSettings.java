...
public class GameSettings {
    ...
    public CloudOption cloudOption = CloudOption.FAST;
    public GraphicsFanciness graphicFanciness = GraphicsFanciness.FAST;
    ...
    public GameSettings(Minecraft mcIn, File mcDataDir) {
        cppInit(mcIn, mcDataDir);
    }


    private void cppInit(Minecraft mcIn, File mcDataDir) {
        ...
        try {
            ...
            for (String s : compoundnbt1.keySet()) {
                ...
                try {
                    ...
                    if ("modelGapFix".equals(s)) {
                        AbstractOption.MODEL_GAP_FIX.set(this, s1);
                    }
    ...
    public void saveOptions() {
        if (!Reflector.ClientModLoader_isLoading.exists() || !Reflector.callBoolean(Reflector.ClientModLoader_isLoading)) {
            try (PrintWriter printwriter = new PrintWriter(new OutputStreamWriter(new FileOutputStream(this.optionsFile), StandardCharsets.UTF_8))) {
                ...
                printwriter.println("modelGapFix:" + AbstractOption.MODEL_GAP_FIX.get(this));
