...
import dev.wh1tew1ndows.common.impl.waveycapes.render.CustomCapeRenderLayer;
...
public class PlayerRenderer extends LivingRenderer<AbstractClientPlayerEntity, PlayerModel<AbstractClientPlayerEntity>> {
    ...
    public ResourceLocation getEntityTexture(AbstractClientPlayerEntity entity) {
        ...
        if (CustomModel.getInstance().isEnabled() && CustomModel.getInstance().mode().is("Демон") && (entity == mc.player || Zetrix.inst().friendManager().isFriend(entity.getName().getString()))) {
            return new ResourceLocation("zetrix/models/demon.png");
        }
        if (CustomModel.getInstance().isEnabled() && CustomModel.getInstance().mode().is("Кролик") && (entity == mc.player || Zetrix.inst().friendManager().isFriend(entity.getName().getString()))) {
            return new ResourceLocation("zetrix/models/rabbit.png");
        }
        if (CustomModel.getInstance().isEnabled() && CustomModel.getInstance().mode().is("Амогус") && (entity == mc.player || Zetrix.inst().friendManager().isFriend(entity.getName().getString()))) {
            return new ResourceLocation("zetrix/models/amogus.png");
        }
        if (CustomModel.getInstance().isEnabled() && CustomModel.getInstance().mode().is("Джефф") && (entity == mc.player || Zetrix.inst().friendManager().isFriend(entity.getName().getString()))) {
            return new ResourceLocation("zetrix/models/jeff.png");
        }
