...
public class GPUWarning extends ReloadListener<GPUWarning.GPUInfo> {
     ...
     */
    protected GPUWarning.GPUInfo prepare(IResourceManager resourceManagerIn) {
        List<Pattern> list = Lists.newArrayList();
        List<Pattern> list1 = Lists.newArrayList();
        List<Pattern> list2 = Lists.newArrayList();

        JsonObject jsonobject = func_241696_c_(resourceManagerIn);
    ...
    protected void apply(GPUWarning.GPUInfo objectIn, IResourceManager resourceManagerIn) {
    ...
    @Nullable
    private static JsonObject func_241696_c_(IResourceManager p_241696_0_) {
