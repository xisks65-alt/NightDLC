...
public class PlayerProfileCache {
    ...
    private Stream<PlayerProfileCache.ProfileEntry> func_242117_a(int p_242117_1_) {
        return ImmutableList.copyOf(this.uuidToProfileEntryMap.values()).stream().sorted(Comparator.comparing(PlayerProfileCache.ProfileEntry::func_242128_c).reversed()).limit(p_242117_1_);
    }
