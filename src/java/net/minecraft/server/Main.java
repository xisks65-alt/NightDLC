...
public class Main {
    ...
    public static void main(String[] p_main_0_) {
        ...
        try {
            ...
            CompletableFuture<DataPackRegistries> completablefuture = DataPackRegistries.func_240961_a_(resourcepacklist.getResourcePacks(), Commands.EnvironmentType.DEDICATED, serverpropertiesprovider.getProperties().functionPermissionLevel, Util.getServerExecutor(), Runnable::run);
            DataPackRegistries datapackregistries;

            try {
                datapackregistries = completablefuture.get();
            } catch (Exception exception) {
                field_240759_a_.warn("Failed to load datapacks, can't proceed with server load. You can either fix your datapacks or reset to vanilla with --safeMode", exception);
            ...
            field_240759_a_.fatal("Failed to start the minecraft server", exception1);
        }
    }
