...
public class Commands {
        ...
        try {
            ...
            if (commandsyntaxexception.getInput() != null && commandsyntaxexception.getCursor() >= 0) {
                ...
                if (j < commandsyntaxexception.getInput().length()) {
                    ITextComponent itextcomponent = (new StringTextComponent(commandsyntaxexception.getInput().substring(j))).mergeStyle(TextFormatting.RED, TextFormatting.UNDERLINE);
            ...
            if (SharedConstants.developmentMode) {
                ...
                LOGGER.error("'" + command + "' threw an exception", exception);
            }
    ...
    public enum EnvironmentType {
        ...
        EnvironmentType(boolean p_i232149_3_, boolean p_i232149_4_) {
