...
import dev.wh1tew1ndows.client.managers.module.impl.player.AutoTool;
...
public abstract class PlayerEntity extends LivingEntity {
    ...
    public float getDigSpeed(BlockState state) {
        ...
        if (f > 1.0F) {
            ...
            ItemStack itemstack = (this.itemStackMainHand);
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag5) {
                        if (i > 0) {
                            ...
                            boolean keepSprint = sprint.isEnabled() && sprint.keepSprint.getValue() && !Minecraft.getInstance().player.isInWater()
                                    && this instanceof ClientPlayerEntity && AttackAura.getInstance().target != null;
