...
public class ItemFrameEntity extends HangingEntity {
    ...
    public boolean onValidSurface() {
        if (this.fixed) {
            ...
            return (blockstate.getMaterial().isSolid() || this.facingDirection.getAxis().isHorizontal() && RedstoneDiodeBlock.isDiode(blockstate)) && this.world.getEntitiesInAABBexcluding(this, this.getBoundingBox(), IS_HANGING_ENTITY).isEmpty();
        }
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (this.fixed) {
            return (source == DamageSource.OUT_OF_WORLD || source.isCreativePlayer()) && super.attackEntityFrom(source, amount);
