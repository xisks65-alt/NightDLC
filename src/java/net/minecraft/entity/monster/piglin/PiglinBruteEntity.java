...
public class PiglinBruteEntity extends AbstractPiglinEntity {
    ...
    public static AttributeModifierMap.MutableAttribute func_242344_eS() {
        return MonsterEntity.func_234295_eP_().createMutableAttribute(Attributes.MAX_HEALTH, 50.0D).createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.35F).createMutableAttribute(Attributes.ATTACK_DAMAGE, 7.0D);
    }
    ...
    public boolean func_230293_i_(ItemStack p_230293_1_) {
        return p_230293_1_.getItem() == Items.GOLDEN_AXE && super.func_230293_i_(p_230293_1_);
    }
