...
public class MovementController {
    ...
    private boolean func_234024_b_(float p_234024_1_, float p_234024_2_) {
        ...
        if (pathnavigator != null) {
            ...
            return nodeprocessor == null || nodeprocessor.getPathNodeType(this.mob.world, MathHelper.floor(this.mob.getPosX() + (double) p_234024_1_), MathHelper.floor(this.mob.getPosY()), MathHelper.floor(this.mob.getPosZ() + (double) p_234024_2_)) == PathNodeType.WALKABLE;
        }
