...
public class Blocks {
    ...
    public static final Block LAVA = register("lava", new FlowingFluidBlock(Fluids.LAVA, AbstractBlock.Properties.create(Material.LAVA).doesNotBlockMovement().tickRandomly().hardnessAndResistance(100.0F).setLightLevel((state) -> 15).noDrops()));
    ...
    public static final Block SHULKER_BOX = register("shulker_box", createShulkerBoxFromColorAndProperties(null, AbstractBlock.Properties.create(Material.SHULKER)));
