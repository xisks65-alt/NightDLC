...
public final class WorldEntitySpawner {
        ...
        if (!blockstate.isNormalCube(p_234966_2_, p_234966_3_)) {
            ...
            for (int k = 0; k < 3; ++k) {
                ...
                for (int i2 = 0; i2 < k1; ++i2) {
                    ...
                    PlayerEntity playerentity = p_234966_1_.getClosestPlayer(d0, i, d1, -1.0D, false);

                    if (playerentity != null) {
                        double d2 = playerentity.getDistanceSq(d0, i, d1);
    ...
    private static boolean func_234978_a_(ServerWorld p_234978_0_, IChunk p_234978_1_, BlockPos.Mutable p_234978_2_, double p_234978_3_) {
        if (p_234978_3_ <= 576.0D) {
            return false;
        } else if (p_234978_0_.getSpawnPoint().withinDistance(new Vector3d((double) p_234978_2_.getX() + 0.5D, p_234978_2_.getY(), (double) p_234978_2_.getZ() + 0.5D), 24.0D)) {
            return false;
        } else {
    ...
    private static boolean func_234975_a_(ServerWorld p_234975_0_, EntityClassification p_234975_1_, StructureManager p_234975_2_, ChunkGenerator p_234975_3_, MobSpawnInfo.Spawners p_234975_4_, BlockPos.Mutable p_234975_5_, double p_234975_6_) {
        ...
        if (entitytype.getClassification() == EntityClassification.MISC) {
            ...
            if (!canCreatureTypeSpawnAtLocation(entityspawnplacementregistry$placementtype, p_234975_0_, p_234975_5_, entitytype)) {
                ...
                return p_234975_0_.hasNoCollisions(entitytype.getBoundingBoxWithSizeApplied((double) p_234975_5_.getX() + 0.5D, p_234975_5_.getY(), (double) p_234975_5_.getZ() + 0.5D));
            }
        } else {
            return false;
        }
    ...
    private static boolean func_234976_a_(ServerWorld p_234976_0_, StructureManager p_234976_1_, ChunkGenerator p_234976_2_, EntityClassification p_234976_3_, MobSpawnInfo.Spawners p_234976_4_, BlockPos p_234976_5_) {
        return func_241463_a_(p_234976_0_, p_234976_1_, p_234976_2_, p_234976_3_, p_234976_5_, null).contains(p_234976_4_);
    }
                ...
                for (int l1 = 0; l1 < k; ++l1) {
                    ...
                    for (int i2 = 0; !flag && i2 < 4; ++i2) {
                        ...
                        if (mobspawninfo$spawners.type.isSummonable() && canCreatureTypeSpawnAtLocation(EntitySpawnPlacementRegistry.getPlacementType(mobspawninfo$spawners.type), worldIn, blockpos, mobspawninfo$spawners.type)) {
                            ...
                            double d0 = MathHelper.clamp(l, (double) i + (double) f, (double) i + 16.0D - (double) f);
                            double d1 = MathHelper.clamp(i1, (double) j + (double) f, (double) j + 16.0D - (double) f);

                            if (!worldIn.hasNoCollisions(mobspawninfo$spawners.type.getBoundingBoxWithSizeApplied(d0, blockpos.getY(), d1)) || !EntitySpawnPlacementRegistry.canSpawnEntity(mobspawninfo$spawners.type, worldIn, SpawnReason.CHUNK_GENERATION, new BlockPos(d0, blockpos.getY(), d1), worldIn.getRandom())) {
                                continue;
                            }
                            ...
                            entity.setLocationAndAngles(d0, blockpos.getY(), d1, diameterX.nextFloat() * 360.0F, 0.0F);
