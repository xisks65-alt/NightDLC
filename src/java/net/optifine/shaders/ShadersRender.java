...
public class ShadersRender {
    ...
    public static void updateActiveRenderInfo(ActiveRenderInfo activeRenderInfo, Minecraft mc, float partialTicks) {
        activeRenderInfo.update(mc.world, mc.getRenderViewEntity() == null ? mc.player : mc.getRenderViewEntity(), !mc.gameSettings.getPointOfView().firstPerson(), mc.gameSettings.getPointOfView().thirdPersonFront(), partialTicks);
    }
