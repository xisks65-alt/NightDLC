...
public class GuiShaders extends GuiScreenOF {
    ...
    public void init() {
        ...
        this.addButton(new GuiButtonEnumShaderOption(EnumShaderOption.ANTIALIASING, k, l, i, j));
        this.addButton(new GuiButtonEnumShaderOption(EnumShaderOption.NORMAL_MAP, k, i1 + l, i, j));
    ...
    public void updateButtons() {
        ...
        for (Widget widget : this.buttonList) {
            if (widget instanceof GuiButtonOF guibuttonof) {
    ...
    public void render(MatrixStack matrixStackIn, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredStringWithShadow(matrixStackIn, this.fontRenderer, this.title, this.width / 2, 15, 16777215);
        ...
        if (i < this.width - 5) {
            drawCenteredStringWithShadow(matrixStackIn, this.fontRenderer, s, this.width / 2, this.height - 40, 8421504);
        } else {
            drawStringWithShadow(matrixStackIn, this.fontRenderer, s, 5, this.height - 40, 8421504);
        }
    ...
    public void drawCenteredString(MatrixStack matrixStackIn, String text, int x, int y, int color) {
        drawCenteredStringWithShadow(matrixStackIn, this.fontRenderer, text, x, y, color);
    }
