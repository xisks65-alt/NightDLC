...
public class GuiOtherSettingsOF extends GuiScreenOF {
    ...
    public void init() {
        ...
        AbstractOption[] aabstractoption = new AbstractOption[]{AbstractOption.LAGOMETER, AbstractOption.SHOW_FPS, AbstractOption.ADVANCED_TOOLTIPS, AbstractOption.WEATHER, AbstractOption.TIME, AbstractOption.FULLSCREEN, AbstractOption.AUTOSAVE_TICKS, AbstractOption.SCREENSHOT_SIZE, abstractoption, null};
