...
public class GuiScreenOF extends Screen {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int mouseButton) {
        ...
        if (widget != null && widget.active) {
            if (mouseButton == 1 && widget instanceof IOptionControl ioptioncontrol) {
    ...
    public boolean mouseReleased(double p_mouseReleased_1_, double p_mouseReleased_3_, int p_mouseReleased_5_) {
        if (!this.mousePressed) {
            ...
            return this.getListener() != null && this.getListener().mouseReleased(p_mouseReleased_1_, p_mouseReleased_3_, p_mouseReleased_5_) || super.mouseReleased(p_mouseReleased_1_, p_mouseReleased_3_, p_mouseReleased_5_);
        }
    }

    public boolean mouseDragged(double p_mouseDragged_1_, double p_mouseDragged_3_, int p_mouseDragged_5_, double p_mouseDragged_6_, double p_mouseDragged_8_) {
        return this.mousePressed && super.mouseDragged(p_mouseDragged_1_, p_mouseDragged_3_, p_mouseDragged_5_, p_mouseDragged_6_, p_mouseDragged_8_);
    }
    ...
    public static void drawCenteredString(MatrixStack matrixStackIn, FontRenderer fontRendererIn, IReorderingProcessor textIn, int xIn, int yIn, int colorIn) {
        fontRendererIn.drawStringWithShadow(matrixStackIn, textIn, (float) (xIn - fontRendererIn.func_243245_a(textIn) / 2), (float) yIn, colorIn);
    }
}
