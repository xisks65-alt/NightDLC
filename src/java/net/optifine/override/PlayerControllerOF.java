...
public class PlayerControllerOF extends PlayerController {
    ...
    public ActionResultType rightClickBlock(ClientPlayerEntity player, ClientWorld worldIn, Hand hand, BlockRayTraceResult rayTrace) {
        this.acting = true;
        this.lastClickBlockPos = rayTrace.getPos();
        ActionResultType actionresulttype = super.rightClickBlock(player, worldIn, hand, rayTrace);
        this.acting = false;
        return actionresulttype;
    }
