...
public class FontUtils {
    ...
    public static void reloadFonts() {
        IFutureReloadListener.IStage ifuturereloadlistener$istage = CompletableFuture::completedFuture;
        ...
        if (fontresourcemanager != null) {
            fontresourcemanager.getReloadListener().reload(ifuturereloadlistener$istage, Config.getResourceManager(), executor, minecraft);
        }
    }
}
