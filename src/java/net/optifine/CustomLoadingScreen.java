...
public class CustomLoadingScreen {
    ...
    public void drawBackground(int width, int height) {
        ...
        bufferbuilder.pos(0.0D, height, 0.0D).tex(f3, f4 + f2).color(255, 255, 255, 255).endVertex();
        bufferbuilder.pos(width, height, 0.0D).tex(f3 + f1, f4 + f2).color(255, 255, 255, 255).endVertex();
        bufferbuilder.pos(width, 0.0D, 0.0D).tex(f3 + f1, f4).color(255, 255, 255, 255).endVertex();
