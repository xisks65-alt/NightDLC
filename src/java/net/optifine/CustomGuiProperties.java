...
public class CustomGuiProperties {
    ...
    private boolean matchesBeacon(BlockPos pos, IBlockDisplayReader blockAccess) {
        ...
        if (!(tileentity instanceof BeaconTileEntity beacontileentity)) {
            return false;
        } else {
    ...
    private boolean matchesChest(BlockPos pos, IBlockDisplayReader blockAccess) {
        ...
        if (tileentity instanceof ChestTileEntity chesttileentity) {
            return this.matchesChest(chesttileentity, pos, blockAccess);
        } else if (tileentity instanceof EnderChestTileEntity enderchesttileentity) {
    ...
    private boolean matchesDispenser(BlockPos pos, IBlockDisplayReader blockAccess) {
        ...
        if (!(tileentity instanceof DispenserTileEntity dispensertileentity)) {
            return false;
        } else {
    ...
    private boolean matchesShulker(BlockPos pos, IBlockDisplayReader blockAccess) {
        ...
        if (!(tileentity instanceof ShulkerBoxTileEntity shulkerboxtileentity)) {
            ...
            if (this.colors != null) {
                ...
                return Config.equalsOne(dyecolor, this.colors);
            }
    ...
    private boolean matchesVillager(Entity entity, IBlockDisplayReader blockAccess) {
        if (!(entity instanceof VillagerEntity villagerentity)) {
            ...
            if (this.professions != null) {
                ...
                return MatchProfession.matchesOne(villagerprofession, i, this.professions);
            }
    ...
    private boolean matchesHorse(Entity entity, IBlockDisplayReader blockAccess) {
        if (!(entity instanceof AbstractHorseEntity abstracthorseentity)) {
            ...
            if (this.colors != null && abstracthorseentity instanceof LlamaEntity llamaentity) {
