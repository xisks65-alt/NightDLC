...
public class DynamicLights {
    ...
    private static final Map<String, Integer> mapEntityLightLevels = new HashMap<>();
            ...
            for (int i = 0; i < astring.length; ++i) {
                ...
                if (astring1.length != 2) {
                    ...
                    if (t == null) {
                        ...
                        if (j >= 0 && j <= 15) {
                            mapLightLevels.put(t, Integer.valueOf(j));
                        } else {
        ...
        if (entity == Config.getMinecraft().getRenderViewEntity() && !Config.isDynamicHandLight()) {
            ...
            if (entity.isBurning()) {
                ...
                if (entity instanceof DamagingProjectileEntity) {
                    ...
                    return 15;
                } else if (entity instanceof BlazeEntity blazeentity) {
                    return blazeentity.isBurning() ? 15 : 10;
                } else if (entity instanceof MagmaCubeEntity magmacubeentity) {
